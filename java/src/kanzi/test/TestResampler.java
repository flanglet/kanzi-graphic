...
import kanzi.util.sampling.ICBIUpSampler;
...
public class TestResampler
{
   public static void main(String[] args)
   {
    ...
    public static void roundtrip(Image image, int w, int h, int iter) throws Exception 
    {
        ...
        UpSampler icbi = new ICBIUpSampler(w/2, h/2);
        DownSampler[] subSamplers = new DownSampler[]  { dDecimate, dDecimate, dDecimate, dDecimate, dDecimate, dDCT, dDWT };
        UpSampler[] superSamplers = new UpSampler[]  { uBilinear, uBicubic, icbi, oriented, guided, uDCT, uDWT };
        String[] titles = new String[] { "Bilinear", "Bicubic", "ICBI", "Oriented", "Guided", "DCT", "DWT" };
